...
Release : release
install : all
	@echo "Installing headers files to $(INSTALL_DIRECTORY)/include/ssobjects"
	cp *.h $(INSTALL_DIRECTORY)/include/ssobjects
	@echo "Installing lib files to $(INSTALL_DIRECTORY)/lib"
	cp *.a $(INSTALL_DIRECTORY)/lib
